...
const ActiveMembershipPage = ({ data }) => {
  ...
  data.allMembershipAspenYardCsv.nodes.forEach((item: MembershipRow) => {
    // const sum =
    //   aspenActive.length > 1
    //     ? aspenActive[aspenActive.length - 1] + getDiff(item)
    //     : getDiff(item);
    // aspenActive.push(sum);
    aspenActive.push(Number(item.Active));
  });
  ...
  data.allMembershipConcessionCsv.nodes.forEach((item: MembershipRow) => {
    // const sum =
    //   concessionActive.length > 1
    //     ? concessionActive[concessionActive.length - 1] + getDiff(item)
    //     : getDiff(item);
    // concessionActive.push(sum);
    concessionActive.push(Number(item.Active));
  });
  ...
  data.allMembershipEmployeeCsv.nodes.forEach((item: MembershipRow) => {
    // const sum =
    //   employeeActive.length > 1
    //     ? employeeActive[employeeActive.length - 1] + getDiff(item)
    //     : getDiff(item);
    // employeeActive.push(sum);
    employeeActive.push(Number(item.Active));
  });
  ...
  data.allMembershipPayItForwardCsv.nodes.forEach((item: MembershipRow) => {
    // const sum =
    //   payForwardActive.length > 1
    //     ? payForwardActive[payForwardActive.length - 1] + getDiff(item)
    //     : getDiff(item);
    // payForwardActive.push(sum);
    payForwardActive.push(Number(item.Active));
  });
  ...
  data.allMembershipStandardCsv.nodes.forEach((item: MembershipRow) => {
    // const sum =
    //   standardActive.length > 1
    //     ? standardActive[standardActive.length - 1] + getDiff(item)
    //     : getDiff(item);
    // standardActive.push(sum);
    standardActive.push(Number(item.Active));
  });
  ...
  data.allMembershipVolunteerCsv.nodes.forEach((item: MembershipRow) => {
    // const sum =
    //   volunteerActive.length > 1
    //     ? volunteerActive[volunteerActive.length - 1] + getDiff(item)
    //     : getDiff(item);
    // volunteerActive.push(sum);
    volunteerActive.push(Number(item.Active));
  });
