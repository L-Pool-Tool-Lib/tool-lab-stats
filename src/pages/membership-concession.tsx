...
const ConcessionMembershipPage = ({ data }) => {
  const labels: string[] = [];
  const active: number[] = [];
  ...
  data.allMembershipConcessionCsv.nodes.forEach(
    (item: {
      // node: {
      // Count_sum: number;
      // male_sum: number;
  ...
  > = {
    ...
    plugins: {
      ...
      title: {
        display: true,
        text: "Evolution of Concession Membership",
      },
    },
  };
...
export default ConcessionMembershipPage;
