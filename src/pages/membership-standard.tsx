...
const StandardMembershipPage = ({ data }) => {
  const labels: string[] = [];
  const active: number[] = [];
  ...
  data.allMembershipStandardCsv.nodes.forEach(
    (item: {
      // node: {
      // Count_sum: number;
      // male_sum: number;
  ...
  > = {
    ...
    plugins: {
      ...
      title: {
        display: true,
        text: "Evolution of Standard Membership",
      },
    },
  };
...
export default StandardMembershipPage;
